...
gulp.task('javascripts', function() {
  javascripts = gulp.src(mainBowerFiles({filter: new RegExp('.js$')}).concat(['./bower_components/jquery-visible/jquery.visible.js', './src/javascripts/core/main.js.coffee', './src/*/javascripts/main.js.coffee', './src/core/javascripts/services/widget.js.coffee', './src/core/javascripts/collections/base.js.coffee', './src/widget/templates.js', './src/*/javascripts/**/*', './src/*/templates.js', '!./**/*~',]))
    // .pipe(filelog())
